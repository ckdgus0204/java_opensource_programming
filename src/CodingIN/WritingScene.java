...
public class WritingScene extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WritingScene frame = new WritingScene();
	...
	public WritingScene() {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent arg0) {
				...
				try {
					db.Error_register( title, LoginMenu.user_id, lang,e_image , des);
		...
		lang_text = new JTextField();
		lang_text.setBounds(359, 393, 130, 29);
		contentPane.add(lang_text);
		lang_text.setColumns(10);
		
		JLabel lblNewLabel_3 = new JLabel("언어");
		lblNewLabel_3.setBackground(SystemColor.activeCaptionBorder);
		lblNewLabel_3.setBounds(256, 393, 80, 27);
